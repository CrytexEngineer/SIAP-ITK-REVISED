                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-3">
                                <?php echo e(Form::text('KE_Jadwal_Ruangan',null,['class'=>'form-control','placeholder'=>'Ruangan [Contoh B201]'])); ?>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-4">
                                <?php echo e(Form::select('PS_Kode_Prodi',$major ?? '',null,['class'=>'form-control'])); ?>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-2">
                                <?php echo e(Form::text('KE_RencanaTatapMuka',null,['class'=>'form-control','placeholder'=>'Rencana Tatap Muka'])); ?>
