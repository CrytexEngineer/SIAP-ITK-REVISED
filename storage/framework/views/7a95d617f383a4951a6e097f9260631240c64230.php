                    ...
                    <div class="card-body">
                        <form method="POST" action="<?php echo e(route('register')); ?>">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input id="PE_Nip" type="text" class="form-control <?php $__errorArgs = ['PE_Nip'];
...
unset($__errorArgs, $__bag); ?>" name="PE_Nip" value="<?php echo e(old('PE_Nip')); ?>" required autocomplete="PE_Nip" autofocus>

                                    <?php $__errorArgs = ['PE_Nip'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Arsip Tugas\FINAL ASSIGMENT\SIAP_ITK\resources\views/register/pegawai.blade.php ENDPATH**/ ?>