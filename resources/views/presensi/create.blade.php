                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group row">
                            <label class="col-md-3 col-form-label text-md-right">Pertemuan</label>
                            <div class="col-md-4">
                                {{Form::select('PT_ID',$meeting,null,['class'=>'form-control','placeholder'=>'Pilih Pertemuan'])}}

                            </div>
                        </div>

                        <div class="form-group row">
                            <label class="col-md-3 col-form-label text-md-right">Keterangan</label>
                            <div class="col-md-4">

                                 {{Form::select('PT_Keterangan',['HADIR'=>'Hadir','SAKIT'=>'Sakit','IZIN'=>'Izin'],null,['class'=>'form-control','placeholder'=>'Pilih Keterangan'])}}
