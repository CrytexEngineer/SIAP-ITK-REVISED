<div class="form-group row">
    ...
    <div class="col-md-2">
        {{ Form::text('KE_ID',null,['class'=>'form-control','placeholder'=>'Kode Kelas'])}}
    </div>
</div>
...
<div class="form-group row">
    ...
    <div class="col-md-6">
        {{Form::select('KE_KR_MK_ID',$subjects,null,['class'=>'form-control'])}}
    </div>
</div>
...
<div class="form-group row">
    ...
    <div class="col-md-4">
        {{ Form::text('KE_Kelas',null,['class'=>'form-control','placeholder'=>'Nama Kelas (A/B/Lainnya)'])}}
    </div>
</div>
...
<div class="form-group row">
    ...
    <div class="col-md-4">
        {{Form::select('KE_KodeJurusan',$major,null,['class'=>'form-control'])}}
    </div>
</div>
