...
class StudentBySubjectSheet implements WithEvents, WithStrictNullComparison, ShouldAutoSize, WithCustomStartCell, WithTitle
{
    ...
    public function registerEvents(): array
    {
        return [
            ...
            AfterSheet::class => function (AfterSheet $event) {
                ...
                $data = Presence::countBySubject(['MK_ID' => $this->MK_ID]);
