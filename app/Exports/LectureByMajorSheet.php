...
class LectureByMajorSheet implements WithEvents, WithStrictNullComparison, ShouldAutoSize, WithCustomStartCell, WithTitle
{
    ...
    public function registerEvents(): array
    {
        return [
            ...
            AfterSheet::class => function (AfterSheet $event) {
                ...
                $data = Meeting::count(['KE_KodeJurusan' => $this->PS_Kode_Prodi]);
