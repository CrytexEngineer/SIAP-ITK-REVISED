...

{
    ...
    public function up()
    {
        Schema::create('class_student', function (Blueprint $table) {
            ...
            $table->foreign('KU_KE_KodeJurusan')->references('KE_KodeJurusan')->on('classes')->onDelete('cascade')->onUpdate('cascade');
            $table->timestamps();
        });
    }
